...
public class HuffmanCompressor {
  ...
  public static String huffmanEncoder(String inputFileName, String encodingFileName, String outputFileName) {
    ...
    try {
      ...
      /* Determines if the encoding process was sucessful */
      if (encodingSuccess) {
  ...
  public static void encodeFile(String inputFileName, String outputFileName, HuffmanNode rootNode) throws IOException {
    ...
    try {
      ...
      if (reader2.read() != -1) { //if the first char is null or if it is empty
  ...
  /*
   * Main method
   * IF THE MAIN METHOD IS NOT WORKING - use command: HuffmanCompressor.huffmanEncoder("inputFileName", "encodingFileName", "outputFileName")
   */
  public static void main(String[] args) {
    
    try {
      HuffmanCompressor.huffmanEncoder("Gatsby.txt", "Gatsby.txt", "lol.txt");
    }
...
/* what if the input file contains characters the encoding file does not */
